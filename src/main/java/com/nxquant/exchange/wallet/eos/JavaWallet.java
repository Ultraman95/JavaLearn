...
import com.nxquant.exchange.wallet.eos.exception.KeyException;
import com.nxquant.exchange.wallet.eos.exception.SignatureException;
import com.nxquant.exchange.wallet.eos.exception.WalletException;
import com.nxquant.exchange.wallet.eos.messages.Keys;
import com.nxquant.exchange.wallet.eos.messages.SignedTransaction;
import com.nxquant.exchange.wallet.eos.messages.Transaction;
import com.nxquant.exchange.wallet.eos.util.Base58;
import com.nxquant.exchange.wallet.eos.util.EOSByteWriter;
import com.nxquant.exchange.wallet.eos.util.EOSKeysUtil;
import com.nxquant.exchange.wallet.eos.util.HMacDSAKCalculator2;
...
public class JavaWallet implements Wallet {
    ...
    @Override
    public String createKey(String walletName) throws WalletException {
